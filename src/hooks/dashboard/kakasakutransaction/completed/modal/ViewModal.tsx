...
interface ViewModalProps {
    ...
    transaction: KakasakuTransaction | null;
    kakaSakuList: KakaSaku[];
}

export default function ViewModal({ open, onOpenChange, transaction, kakaSakuList }: ViewModalProps) {
            ...
            <DialogContent className="max-w-2xl">
                ...
                {transaction && (
                    <div className="space-y-6">
                        ...
                        <div>
                            <h4 className="font-semibold mb-2">Kaka Saku</h4>
                            <p className="text-gray-600">{getKakaSakuTitle(transaction.kaka_saku_id)}</p>
                        </div>
